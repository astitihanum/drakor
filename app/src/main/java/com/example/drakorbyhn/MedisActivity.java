...
public class MedisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo.add(new DramaLogo(R.drawable.doctor_stranger,"Lee Jong-suk, Jin Se-yeon, Park Hae-jin, dan Kang Sora"," Hyun Bin, Son Ye-jin, Kim Jung-hyun, dan Seo Ji-hye",
